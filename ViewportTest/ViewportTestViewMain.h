...
// ViewportTestView.h : CViewportTestViewMain クラスのインターフェイス
//
...
class CViewportTestViewMain : public CView
{
public: // シリアル化からのみ作成します。
	CViewportTestViewMain();
	DECLARE_DYNCREATE(CViewportTestViewMain)
...
public:
	...
	typedef void (CViewportTestViewMain::*RV1EventHnadler)();
...
public:
	...
	afx_msg LRESULT OnViewDlgShowHide(WPARAM wParam, LPARAM lParam);
};

#ifndef _DEBUG  // ViewportTestView.cpp のデバッグ バージョン
inline CViewportTestDoc* CViewportTestViewMain::GetDocument() const
