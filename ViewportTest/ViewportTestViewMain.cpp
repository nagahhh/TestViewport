...
IMPLEMENT_DYNCREATE(CViewportTestViewMain, CView)

BEGIN_MESSAGE_MAP(CViewportTestViewMain, CView)
	// 標準印刷コマンド
	...
	ON_WM_LBUTTONDOWN()
	ON_WM_CREATE()
	ON_COMMAND(IDTB_BUTTON_0, &CViewportTestViewMain::OnIdtbButton0)
	ON_COMMAND(IDTB_BUTTON_1, &CViewportTestViewMain::OnIdtbButton1)
	ON_COMMAND(IDTB_BUTTON_2, &CViewportTestViewMain::OnIdtbButton2)
	ON_COMMAND(IDTB_BUTTON_3, &CViewportTestViewMain::OnIdtbButton3)
	ON_COMMAND(IDM_COMBO, &CViewportTestViewMain::OnCombo)
	ON_CBN_EDITCHANGE(IDM_COMBO, &CViewportTestViewMain::OnCombo)
	ON_CBN_SELCHANGE(IDM_COMBO, &CViewportTestViewMain::OnCombo)
	ON_WM_LBUTTONUP()

	ON_MESSAGE(WM_VIEWDLGONOFF, OnViewDlgShowHide)
END_MESSAGE_MAP()

LRESULT CViewportTestViewMain::OnViewDlgShowHide(WPARAM wParam, LPARAM lParam)
{
	UNREFERENCED_PARAMETER(wParam);
	UNREFERENCED_PARAMETER(lParam);

	m_wndToolBar.GetToolBarCtrl().CheckButton(IDTB_BUTTON_3, CViewDlg::isShown());
...
// CViewportTestViewMain コンストラクション/デストラクション

CViewportTestViewMain::CViewportTestViewMain()
{
	...
	RV1Event[RV1EventID::EVENT0] = &CViewportTestViewMain::onEvent0;
	RV1Event[RV1EventID::EVENT1] = &CViewportTestViewMain::onEvent1;
	RV1Event[RV1EventID::EVENT2] = &CViewportTestViewMain::onEvent2;
	RV1Event[RV1EventID::EVENT3] = &CViewportTestViewMain::onEvent3;
}
...
//BOOL CViewportTestViewMain::PreCreateWindow(CREATESTRUCT& cs)
//{
...
// CViewportTestViewMain 描画

void CViewportTestViewMain::OnDraw(CDC* pDC)
{
...
void CViewportTestViewMain::initRect()
{
...
void CViewportTestViewMain::drawGrid(CDC* pDC)
{
...
void CViewportTestViewMain::drawCurvatureLine(CDC* pDC)
{
...
void CViewportTestViewMain::drawCurvatureHeader(CDC* pDC)
{
	CPen pen(PS_SOLID, 0, RGB(0, 0, 255));
	pDC->SelectObject(pen);
...
void CViewportTestViewMain::drawCurvatureFrame(CDC* pDC)
{
	CPen pen(PS_SOLID, 0, RGB(0, 0, 255));
	pDC->SelectObject(pen);
...
void CViewportTestViewMain::drawRgn2(CDC* pDC)
{
	CRgn   rgnA, rgnB;
	CRgn   rgnC;
...
void CViewportTestViewMain::drawRgn(CDC* pDC)
{
	CRgn   rgnA, rgnB;
...
void CViewportTestViewMain::beginDrawing(CDC* pDC)
{
	m_penOld = pDC->SelectObject(&m_pen1);
	m_brushOld = pDC->SelectObject(&m_brushHollow);
}

void CViewportTestViewMain::endDrawing(CDC* pDC)
{
	pDC->SelectObject(m_penOld);
	pDC->SelectObject(m_brushOld);
}

void CViewportTestViewMain::drawFrame(CDC* pDC)
{
...
void CViewportTestViewMain::drawSample(CDC* pDC)
{
	CPoint p1;
	CPoint p2;
...
// CViewportTestViewMain 印刷

BOOL CViewportTestViewMain::OnPreparePrinting(CPrintInfo* pInfo)
{
	// 既定の印刷準備
	return DoPreparePrinting(pInfo);
}

void CViewportTestViewMain::OnBeginPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
	// TODO: 印刷前の特別な初期化処理を追加してください。
}

void CViewportTestViewMain::OnEndPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
	// TODO: 印刷後の後処理を追加してください。
}


// CViewportTestViewMain 診断

#ifdef _DEBUG
void CViewportTestViewMain::AssertValid() const
{
	CView::AssertValid();
}

void CViewportTestViewMain::Dump(CDumpContext& dc) const
{
	CView::Dump(dc);
}

CViewportTestDoc* CViewportTestViewMain::GetDocument() const // デバッグ以外のバージョンはインラインです。
{
...
// CViewportTestViewMain メッセージ ハンドラー


BOOL CViewportTestViewMain::OnMouseWheel(UINT nFlags, short zDelta, CPoint pt)
{
...
void CViewportTestViewMain::OnMouseMove(UINT nFlags, CPoint point)
{
	// TODO: ここにメッセージ ハンドラー コードを追加するか、既定の処理を呼び出します。
...
void CViewportTestViewMain::invalidateRect()
{
	CRect rect = m_rectClient;
...
void CViewportTestViewMain::OnMButtonDown(UINT nFlags, CPoint point)
{
	m_ptOld = point;
}


void CViewportTestViewMain::OnSize(UINT nType, int cx, int cy)
{
	if (m_ptOrg.x == INT_MIN)
		return;
...
void CViewportTestViewMain::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags)
{
...
void CViewportTestViewMain::OnLButtonDown(UINT nFlags, CPoint point)
{
	// TODO: ここにメッセージ ハンドラー コードを追加するか、既定の処理を呼び出します。
...
int CViewportTestViewMain::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void CViewportTestViewMain::OnIdtbButton0()
{
	m_spinCtrlDlg.DoModal();
}


void CViewportTestViewMain::OnIdtbButton1()
{
...
void CViewportTestViewMain::OnIdtbButton2()
{
...
void CViewportTestViewMain::OnIdtbButton3()
{
	CViewDlg::m_pDocS = GetDocument();
	CViewDlg::toggleShowHide();
}

void CViewportTestViewMain::OnCombo()
{
...
void CViewportTestViewMain::OnLButtonUp(UINT nFlags, CPoint point)
{
...
BOOL CViewportTestViewMain::OnCommand(WPARAM wParam, LPARAM lParam)
{
	if (wParam == 1L)
	{
		MessageBox(_T("TEST"));
